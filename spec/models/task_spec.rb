...
describe "Task" do
  describe "#create" do
    describe "with valid data", "Step 4 - Unskip this test.  Run `rspec spec/models/task_spec.rb` to focus on the task model" do
      before do
    ...
    describe "without a description", "Step 30: Unskip this test and the one below" do
      let(:task){ Task.new }
      before { task.save }
    ...
    describe "with a blank description", "Step 30: Unskip this test and the one above" do
