...
feature "Managing Tasks", js: true do
  scenario "viewing the homepage with todo items", "Step 2 - Unskip this test" do
  ...
  scenario "viewing the homepage without todo items", "Step 12: Unskip this test" do
    visit "/"
    page.should_not have_content "This page will soon be home to a TODO app!"
    page.should have_content "There are no tasks remaining! You should add one!"
  end

  scenario "creating a new todo item", "Step 16: Unskip this test" do
  ...
  scenario "creating a new todo with invalid data", "Step 28: Unskip this test" do
    visit "/"
    click_link "Add task"
  ...
  scenario "updating a todo item with invalid data", "Step 39: Unskip this test" do
    Task.create(description: 'Eat Breakfast')
    visit '/'
  ...
  scenario "deleting a todo",  "Step 40: Unskip this test" do
    Task.create(description: 'Eat Breakfast')
